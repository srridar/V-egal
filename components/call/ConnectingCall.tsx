...
export default function ConnectingCall({ user , onEndCall}: Props) {
  return (
    <div className="fixed inset-0 z-[9999] bg-zinc-950 flex flex-col items-center justify-center">
      ...
      <h2 className="mt-6 text-3xl font-semibold text-white"> {user.username} </h2>
      <p className="mt-3 text-green-400 font-medium"> Audio Call Accepted </p>

      <div className="mt-6 flex flex-col items-center gap-3">
        <LoaderCircle className="w-10 h-10 text-white animate-spin"/>
        <p className="text-zinc-400"> Connecting securely... </p>
      </div>
